...
export const TextAreaEncodeDecode = ({ encodeSet, encodeValue, encodeLabel, encodeStatus, decodeSet, decodeValue, decodeLabel, decodeStatus }: Props): React.ReactElement => {
    return (
